...
import { fulfillFulfillment } from "@/lib/modules/fulfillment/fulfillment-service";
...
/** POST /api/fulfillment/[id]/fulfill — fulfills allocated stock, releases reservations. */
export async function POST(
  ...
  try {
    ...
    const fulfillment = await fulfillFulfillment(idParsed.data, api.user);
