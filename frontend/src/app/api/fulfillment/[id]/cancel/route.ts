...
import { cancelFulfillment } from "@/lib/modules/fulfillment/fulfillment-service";
...
/** POST /api/fulfillment/[id]/cancel — cancels and releases every reservation. */
export async function POST(
  ...
  try {
    ...
    const fulfillment = await cancelFulfillment(idParsed.data, api.user);
