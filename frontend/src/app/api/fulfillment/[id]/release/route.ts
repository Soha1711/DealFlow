...
import { releaseBackorder } from "@/lib/modules/fulfillment/fulfillment-service";
...
/** POST /api/fulfillment/[id]/release — allocates newly available stock for backorders. */
export async function POST(
  ...
  try {
    ...
    const fulfillment = await releaseBackorder(idParsed.data, api.user);
