...
import { allocateFulfillment } from "@/lib/modules/fulfillment/fulfillment-service";
...
/** POST /api/fulfillment/[id]/allocate — deterministic multi-warehouse allocation. */
export async function POST(
  ...
  try {
    ...
    const fulfillment = await allocateFulfillment(idParsed.data, api.user);
